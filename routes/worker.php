...
// Worker bookings management
Route::get('/bookings', [WorkerBookingController::class, 'index'])->name('worker.bookings.index');
Route::post('/bookings/{id}/accept', [WorkerBookingController::class, 'accept'])->name('worker.bookings.accept');
Route::post('/bookings/{id}/reject', [WorkerBookingController::class, 'reject'])->name('worker.bookings.reject');
Route::post('/bookings/{id}/complete', [WorkerBookingController::class, 'complete'])->name('worker.bookings.complete');
